			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="city" name="city" class="form-control" value="'.$row["address2"].'" pattern="^[a-zA-Z0-9 ]+$" required>
					...
					<div class="col-50">
                        ...
                        <input type="text" class="form-control"  name="cardNumber" pattern="^4[0-9]{12}(?:[0-9]{3})?$" required>
                    </div>
						...
						<div class="col-50">
							<div class="form-group ">
								...
								<input type="text" class="form-control" name="cvv" pattern="^[0-9]{3,4}$" required>
						</div>
						</div>
					</div>
					</div>
