      ...
      <div class="content">
        <div class="container-fluid">
         ...
         <div class="col-md-7">
            ...
            <div class="card"  >
              <div >
                <h5 class="title" style="font-weight:bold;font-family:georgia;font-size:24px;color:white;padding: 1%;" > Add Product</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-5">
            <div class="card">
              <div >
                <h5 class="title"   style="font-weight:bold;font-family:georgia;font-size:24px;color:white;padding: 1%;" >Categories</h5>
              </div>
              <div class="card-body">
              ...
              <div class="card-footer">
                  <button type="submit" id="btn_save" name="btn_save" class="btn1">Update Product</button>
              </div>
            </div>
          </div>
