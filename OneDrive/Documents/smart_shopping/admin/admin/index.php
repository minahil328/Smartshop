		...
		<a>
          ...
          <div class='alert alert-success'>
            ...
            <div >
                ...
                <h4  style="font-family:Fantasy;color:black;font-size:36px;"> Users-Info</h4>
              
          </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead  style="font-family:Fantasy;font-size:36px;color:purple;">
           ...
           <div class="row">
            ...
            <div >
            <div class="container-fluid bg-info">
                <h4  style="font-family:Fantasy;color:black;font-size:36px;"> Categories </h4>
              
          </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary" style="font-family:Fantasy;font-size:36px;">
          ...
          <div class="col-md-6">
            <div >
            <div class="container-fluid bg-info">
                <h4  style="font-family:Fantasy;color:black;font-size:36px;"> Brands</h4>
           ...
           <div class="col-md-5">
            <div >
            <div class="container-fluid bg-info">
                <h4  style="font-family:Fantasy;color:black;font-size:36px;"> Subscribers</h4>
