   ...
   <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                  <h4 class="card-title"style="font-weight:bold;font-family:georgia;font-size:30px;color:white;padding: 1%;">Edit Profile</h4>
                <div class="card-body">
             ...
             <?php endif ?>
                    ...
                    <button class="btn1" type="submit" name="re_password">Update Profile</button>
