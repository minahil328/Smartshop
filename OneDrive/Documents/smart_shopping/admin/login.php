...
<body>
    ...
    <div class="main" style="padding-top: 90px;">
        ...
        <section class="sign-in">
            <div class="container">
                <div class="signin-content" style="background-color:#87cefa;">
                    ...
                    <div class="signin-form">
                        ...
                        <form  class="register-form" id="login-form" action="login.php" method="post">
                            ...
                            <div class="form-group form-button">
                                ...
                                <a href="reg.php" class="signup-image-link"  style="font-family:georgia;size:10px;color:black">Don't have an Account?</a>
