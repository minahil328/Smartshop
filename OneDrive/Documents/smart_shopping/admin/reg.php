...
<body>
    ...
    <div class="main" style="padding-top: 90px;">
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content" style="background-color:#87cefa;">
                    <div class="signup-form">
                        ...
                        <form method="post" class="register-form" id="register-form" action="login.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_2" id="re_pass" placeholder="Retype your password"/>
                            </div>
                          
                            <div class="form-group form-button">
                                <input type="submit" name="reg_user" id="signup" class="form-submit" value="Register"/>
                                <a href="login.php" class="signup-image-link" style="font-family:georgia;size:10px;color:black">Already have an account?</a>

                            </div>
                        </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="./assets/images/761.jpg" alt="sing up image"></figure>
                    </div>
                </div>
            </div>
        </section>
